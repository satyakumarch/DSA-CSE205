//Write a program to take in the min-heap data as input and convert it to
// a max-heap representation which would help in retrieving the largest element from the tree.
